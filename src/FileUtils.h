...
extern std::string account_pw;

extern std::string quote_server_ip;
extern int quote_server_port;
extern std::string quote_username;
extern std::string quote_password;
extern int quote_protocol;
